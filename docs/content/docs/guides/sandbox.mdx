...
- **[createSandbox Reference](/reference/sandbox/create-sandbox)** -- Full API, adapters, and API routes
- **[Full-Stack Setup](/guides/full-stack-setup)** -- Build a custom frontend instead of using the sandbox
