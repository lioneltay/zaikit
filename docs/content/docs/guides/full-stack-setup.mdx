...
- **[AgentProvider Reference](/reference/react/agent-provider)** -- Full props and context API
- **[createAgent Reference](/reference/core/create-agent)** -- `chat()`, `stream()`, and `generate()` methods
